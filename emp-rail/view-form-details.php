                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                     <tr>
                                    <td ><input id="date" readonly disable="true" class="form-control" type="date"></td> 
                                    <td><input id="rg" readonly disable="true" class="form-control" type="text"></td>
                                     <td ><input id="hg" readonly disable="true" class="form-control" type="text"></td>
                                      <td><input id="dg" readonly disable="true" class="form-control" type="text"></td>
                                      <td><input id="hhg" readonly disable="true" class="form-control" type="text"></td>
                                       <td><input id="route" readonly disable="true" class="form-control" type="text"></td>
                                    <td ><input id="c_on" readonly disable="true" class="form-control" type="text"></td> 
                                    <td ><input id="shout" readonly disable="true" class="form-control" type="text"></td> 
                                 <td ><input id="nut_bolt" readonly disable="true" class="form-control" type="text"></td> 
                                 <td ><input id="dome_clean" readonly disable="true" class="form-control" type="text"></td>
                               
                                 <td ><input id="cover" readonly disable="true" class="form-control" type="text"></td> 
                                 <td ><input id="remark" readonly disable="true" class="form-control" type="text"></td>
