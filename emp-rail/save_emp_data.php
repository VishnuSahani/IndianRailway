...
$createdDateTime = date("Y-m-d h:i:sa");
        ...
        if(mysqli_query($con,"insert into emp_info_rail(section_id,station_id,station_name,section_name,empid,empname,empdesg,phone,date_of_app,date_of_ret,created_date)values('$sectionId','$stationId','$stationName','$sectionName','$c','$d','$e','$phone','$appdate','$retdate','$createdDateTime')"))
           {
              echo"success";
