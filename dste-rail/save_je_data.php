...
$createdDateTime = date("Y-m-d h:i:sa");
    ...
    $check=mysqli_query($con,"select * from assign_info_rail where station_id='$stationId'");
    if(mysqli_num_rows($check))
    {
        echo "<span class='text-danger'>Sorry ! This Station Already Assigned to JE</span>";
    }
    else{
