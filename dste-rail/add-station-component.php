...
$(document).ready(()=>{
        ...
        $.ajax({
            ...
            success:function(respo){
                ...
                if(response['status']){
                    ...
                    $("#sectionId").val(dataList['section_id']+'__'+dataList['section_name']);

                    $("#stationId").append(`<option value='${dataList['station_id']+'__'+dataList['station_name']}'>${dataList['station_name']}</option>`);

                    $("#stationId").val(dataList['station_id']+'__'+dataList['station_name']);
    ...
    var url_string = window.location.href;
        ...
        $.ajax({
            type:"POST",
            url:"./query/action.php",
            data:{"action":"stationComponentUpdate","id":id,"stationComponent":stationComponent,"subComponent":subComponentList.join(",")},
            beforeSend:function(){
