...
{
  header('location:../index-dste.php?session_error');   
}	
    ...
    if(isset($_SESSION['userretailerdste']))
{
  $id=$_SESSION['userretailerdste'];  
    ...
    //echo $id;
    $query = mysqli_query($con,"SELECT * FROM dste_info_rail  WHERE binary empid = '$id'");
...
<li class="nav-item"><a href="sse-info.php" class="nav-link  active">View SSC Data</a></li> 
<li class="nav-item"><a href="aste-info.php" class="nav-link  active">View ASTE Data</a></li> 
