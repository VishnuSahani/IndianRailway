...
<div class="container">
  <div class="card-header mt-3 alert alert-primary text-center h3">View SSE </div>
  ...
  <div class="col-12">
    <div class="form-group px-2">
      ...
      <div class="my-1">
        ...
        $query = mysqli_query($con, "SELECT * FROM assign_aste_rail WHERE empid='$id'");
