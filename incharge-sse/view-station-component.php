...
if (isset($_SESSION['userretailersse'])) {
    $id = $_SESSION['userretailersse'];
...
<input type="hidden" id="sectionName" disabled>
<input type="hidden" id="stationName" disabled>
<div class="container" style="margin-top:30px;">

    <div class="alert alert-primary d-flex justify-content-between align-items-center">
        <div></div>
        <p class="text-center h5">Form Station Component </p>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:middle;width:12%">
                                    <select class="custom-select CS1Class" id="cs1_1">
                                        ...
                                        <option class="heading_hindi" value="चेक नहीं किया गया">चेक नहीं किया गया
                                        </option>
                                    </select>
                                </td>
                            </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead class="text-center table-dark">
                                                ...
                                                <tr>
                                                    <td>
                                                        <span class="heading_english">Volt</span>
...
function createSubComponent(val) {
    ...
    `;
        ...
        btn1 = `
    <button class="btn btn-${btnColor} mx-2" type="button" onclick="get_CP_formData('CP1','NA','${stationComName}')">CP1</button>
    <button class="btn btn-${btnColor} mx-2" type="button" onclick="get_CP_formData('CP2','NA','${stationComName}')">CP2</button>
    <button class="btn btn-${btnColor} mx-2" type="button" onclick="get_CP_formData('CP3','NA','${stationComName}')">CP3</button>
    `;
...
function getComponent(stationId) {

    let sectionId = ($("#sectionId").val()).trim();
    let tmpSectionList = sectionStationData.filter((x)=> x.station_id == stationId);
    if(!tmpSectionList.length){
         alert("Please refresh the page and try again");
         return;
    }
    if(sectionId  == "" || sectionId == null || sectionId == undefined){
           sectionId = tmpSectionList[0]['section_id'];
           $("#sectionId").val(sectionId);
    }

    $("#sectionName").val(tmpSectionList[0]['section_name'])
    $("#stationName").val(tmpSectionList[0]['station_name'])
...
$(document).ready(function() {
    ...
    $("#ep1FormBtn").click(function() {
        if (confirm("Do you want to final submit EP1 Form")) {
            ...
            let userID = '<?php echo $_SESSION['userretailersse']; ?>';
...
let empid = '<?php echo $_SESSION['userretailersse']; ?>';
...
function get_IPS_formData(ips_Type,subCompo,compo){
    ...
    if(ips_Type == "IPS4"){
        checkIPSBatteryFill(subCompo,compo)
        return;
    }
