...
<div class="container">
  <div class="card-header mt-3 alert alert-primary text-center h3">View JE </div>
  ...
  <div class="col-12">
    <div class="form-group px-2">
      ...
      <div class="my-1">
        ...
        $query = mysqli_query($con, "SELECT * FROM assign_incharge_sse_rail WHERE empid='$id'");
...
function showCommonform(empid,from,section_id,section_name,station_id,station_name){
