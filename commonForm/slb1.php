...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
                ...
                if (updateCheck.includes(value)) {
                    ...
                    displayHtml +=
                        `<div id='${element['slb_id']}'><select class="form-control">
                    <option>${value}</option>
                    <option value='${updateValue[value]}'>${updateValue[value]}</option>
                    </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','SLB1','${element['slb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
