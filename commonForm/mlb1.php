    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="mlb1FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="mlb1PdfBtn" onclick="generatePdf('MLB1','pdfBodyMLB1')"
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','MLB1','${element['mlb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','MLB1','${element['mlb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("mlb1_body").innerHTML = displayHtml;
    ...
    function showFormDetails(id, language) {
        ...
        if (id != '') {
            ...
            $.ajax({
                ...
                data: {
                    "common_action": "getMLB_FormDetails",
                    "formType": "MLB1",
                    "language": language
                },
                beforeSend: function () {
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "MLB1" Form</div>`;
