...
<script>
    ...
    <td style="vertical-align:middace;width:22%" >`;
        ...
        if (updateCheck.includes(value)) {
            ...
            </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','DAC2','${element['dac_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
