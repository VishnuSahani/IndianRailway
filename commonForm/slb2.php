        ...
        <div class="modal-content">
           ...
           सीसेई (सिग्नल)/प्रभारी : अर्ध-वार्षिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="slb2FormBtn" class="btn btn-success">Final Submit</button> -->
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','SLB2','${element['slb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','SLB2','${element['slb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("slb2_body").innerHTML = displayHtml;
    ...
    function showFormDetails(id, language) {
        ...
        if (id != '') {
            ...
            $.ajax({
                ...
                data: {
                    "common_action": "getSLB_FormDetails",
                    "formType": "SLB2",
                    "language": language
                },
                beforeSend: function () {
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "SLB2" Form</div>`;
