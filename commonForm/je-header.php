...
<li class="nav-item"><a href="<?php echo $_SESSION['redirectPage']; ?>view-assigned-station.php" class="nav-link  active">View Assigned Station</a></li> 
...
<li class="nav-item"><a href="<?php echo $_SESSION['redirectPage']; ?>add-station-component.php" class="nav-link  active">Station Component</a></li> 
