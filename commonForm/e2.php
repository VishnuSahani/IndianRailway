...
<!-- Modal E2 -->
<div class="modal fade" id="componentForm_E2" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
सीसेई (सिग्नल)/प्रभारी : वार्षिक
                ...
                <div class="border-left">
                    ...
                    <div class="ml-3 font-weight-bold" id="e2_decs_earth" >
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="e2FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="e2PdfBtn" onclick="generatePdf('E2','pdfBodyE2')"
...
<script>
    ...
    function openDialog(dataList, id) {
        ...
        $("#e2_decs_earth").html(tableDataForm['e2_decs_earth']);
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','E2','${element['e_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','E2','${element['e_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("e2_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "E2" Form</div>`;
