...
<script>
    ...
    if (updateCheck.includes(value)) {
        ...
        </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','DB2','${element['db_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
