...
<!-- Modal ELB3 -->
<div class="modal fade" id="componentForm_ELB3" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
           ...
           सीसेई (सिग्नल)/प्रभारी: अर्धवार्षिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="elb3FormBtn" class="btn btn-success">Final Submit</button> -->
...
`;
        ...
        document.getElementById("elb3_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "ELB3" Form</div>`;
