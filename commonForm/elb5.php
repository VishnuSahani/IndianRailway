    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="elb5FormBtn" class="btn btn-success">Final Submit</button> -->
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','ELB5','${element['elb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','ELB5','${element['elb_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("elb5_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "ELB5" Form</div>`;
