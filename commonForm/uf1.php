...
<!-- Modal UF1 -->
<div class="modal fade" id="componentForm_UF1" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="uf1FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="uf1PdfBtn" onclick="generatePdf('UF1','pdfBodyUF1')"
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','UF1','${element['db_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','UF1','${element['db_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("uf1_body").innerHTML = displayHtml;
    ...
    function showFormDetails(id, language) {
        ...
        if (id != '') {
            ...
            $.ajax({
                ...
                data: {
                    "common_action": "getBI_FormDetails",
                    "formType": "UF1",
                    "language": language
                },
                beforeSend: function () {
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "UF1" Form</div>`;
