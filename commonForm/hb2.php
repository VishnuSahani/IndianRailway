...
<!-- Modal HB2 -->
<div class="modal fade" id="componentForm_HB2" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="hb2FormBtn" class="btn btn-success">Final Submit</button> -->
...
`;
        ...
        document.getElementById("hb2_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "HB2" Form</div>`;
