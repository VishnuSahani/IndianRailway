...
सीसेई (सिग्नल)/प्रभारी: वार्षिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="ei3FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="ei3PdfBtn" onclick="generatePdf('EI3','pdfBodyEI3')"
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
                ...
                if (updateCheck.includes(value)) {
                    ...
                    </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','EI3','${element['ei_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
...
`;
        ...
        document.getElementById("ei3_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "EI3" Form</div>`;
