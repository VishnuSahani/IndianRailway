...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','DL3','${element['dl_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','DL3','${element['dl_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("dl3_body").innerHTML = displayHtml;
    ...
    function showFormDetails(id, language) {
        ...
        if (id != '') {
            ...
            $.ajax({
                ...
                data: {
                    "common_action": "getDL_FormDetails",
                    "formType": "DL3",
                    "language": language
                },
                beforeSend: function () {
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "DL3" Form</div>`;
