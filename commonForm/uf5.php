...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
                ...
                </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','UF5','${element['db_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
