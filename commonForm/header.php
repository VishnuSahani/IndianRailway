...
<div class="container-fluid">
  <div class="row" style="color:blue; text-align: center;padding-top:3px;">
    ...
    <div class="col-xl-6 col-lg-6 col-md-12">
     <i class="fa fa-envelope-o" style="color:red;font-size:15px;"></i> 
     <span style="font-size:15px;">help@gmail.com</span>
 ...
 <div  class="row" >
    <div class="col-lg-6 col-6">
      <div class="py-2">
        <img src="../images/logo_colour.gif" class="img-fluid">
      </div>
    </div>
  ...
  <nav class="navbar  navbar-expand-sm  navbar-dark sticky-top" style="background-color: #2f539f;">
    <a class="navbar-brand" href="<?php echo $_SESSION['redirectPage']; ?>" style="color:#FFFFFF;"><i
        class="fa fa-home"></i> </a>
    <!-- <a href="index.php" class="navbar-brand" >IBN DIGITAL</a> -->

    <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#menubar"><span
    ...
    <div id="menubar" class="collapse navbar-collapse">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a href="<?php echo $_SESSION['redirectPage']; ?>" class="nav-link  active">
            <?php echo $from; ?> Dashboard
          </a></li>
