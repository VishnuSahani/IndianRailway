        ...
        <div class="modal-content">
          ...
          Mansoon Precautions  <?php echo date("Y"); ?>
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="mansoonFormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="mansoonPdfBtn" onclick="generatePdf('Mansoon','pdfBodyMansoon')"
...
<script>
    ...
    response.forEach((element,i) => {
        ...
        document.getElementById("mansoon_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "Mansoon" Form</div>`;
