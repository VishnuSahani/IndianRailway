...
सीसेई (सिग्नल)/प्रभारी: वार्षिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="r3FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="r3PdfBtn" onclick="generatePdf('R3','pdfBodyR3')"
...
<script>
    ...
    function openDialog(dataList, id) {
        ...
        dataList.forEach((element, index) => {
            ...
            let value = tableDataForm[element['r_id'].toLowerCase()]
            displayHtml += `
    <tr>
    ...
    <td style="vertical-align:middle;width:22%" >`;
                ...
                if (updateCheck.includes(value)) {
                    ...
                    displayHtml +=
                        `<div id='${element['r_id']}'><select class="form-control">
                    <option>${value}</option>
                    <option value='${updateValue[value]}'>${updateValue[value]}</option>
                    </select> <button type="button" onclick="updateSingleValue('${updateValue[value]}','R3','${element['r_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button></div>`;
...
`;
        ...
        document.getElementById("r3_body").innerHTML = displayHtml;
    ...
    function showFormDetails(id, language) {
        ...
        if (id != '') {
            ...
            $.ajax({
                ...
                data: {
                    "common_action": "getR_FormDetails",
                    "formType": "R3",
                    "language": language
                },
                beforeSend: function () {
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "R3" Form</div>`;
