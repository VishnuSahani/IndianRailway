...
<!-- Modal E1 -->
<div class="modal fade" id="componentForm_E1" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div id="pdfBodyE1">
             ...
             सीसेई (सिग्नल)/प्रभारी: अर्ध-वार्षिक
                ...
                <div class="border-left">
                    ...
                    <div class="ml-3 font-weight-bold" id="e1_decs_earth" >
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="e1FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="e1PdfBtn" onclick="generatePdf('E1','pdfBodyE1')"
...
<script>
    ...
    function openDialog(dataList, id) {
        ...
        $("#e1_decs_earth").html(tableDataForm['e1_decs_earth']);
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','E1','${element['e_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','E1','${element['e_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("e1_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "E1" Form</div>`;
