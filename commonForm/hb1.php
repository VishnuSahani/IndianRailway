...
<!-- Modal HB1 -->
<div class="modal fade" id="componentForm_HB1" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="hb1FormBtn" class="btn btn-success">Final Submit</button> -->
                ...
                displayHtml += `<tr>
                    ...
                    ${element['db_details']}
                        <div class="">
                            <div class="input-group my-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="hb1_earth_reg_label">
                                        ${earthRegValue}
                                    </span>
                                </div>
                                <div class="px-3 py-2 border">${tableDataForm['hb1_earth_reg']}</div>
                            </div>     
                        </div>
                    </td>
                    <td style="vertical-align:middle;width:15%" >
...
`;
        ...
        document.getElementById("hb1_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "HB1" Form</div>`;
