...
<body>
 ...
 <div  class="row" >
    <div class="col-lg-6 col-6">
      <div class="py-2">
        <a role="button"><img src="../images/logo_colour.gif" class="img-fluid"></a>
    </div>
    </div>
...
<nav class="navbar  navbar-expand-sm  navbar-dark sticky-top" style="background-color: #2f539f;">
  <a class="navbar-brand" href="<?php echo $redirectPage ?>index.php" style="color:#FFFFFF;"><i class="fa fa-home"></i> </a>
...
<li class="nav-item"><a href="<?php echo $redirectPage ?>sse-info.php" class="nav-link  active">View SSC Data</a></li> 
<li class="nav-item"><a href="<?php echo $redirectPage ?>aste-info.php" class="nav-link  active">View ASTE Data</a></li> 
...
<li class="nav-item dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="<?php echo $redirectPage ?>pme-due.php">PME Due Today</a>
          <a class="dropdown-item" href="<?php echo $redirectPage ?>pme-due-future.php">PME Due To Date</a>
          
       </div>
     </li>
  <li class="nav-item"><a href="<?php echo $redirectPage ?>refresher-due.php" class="nav-link  active">Refresher Due</a></li> 
...
<li class="nav-item dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="<?php echo $redirectPage ?>assign.php">Assign Station To JE</a>
          <a class="dropdown-item" href="<?php echo $redirectPage ?>view-assigned-station-to-je.php">View Assigned Station To JE</a>
          <a class="dropdown-item" href="<?php echo $redirectPage ?>sse-incharge-assign.php">Assign Station To SSE Incharge</a>
          <a class="dropdown-item" href="<?php echo $redirectPage ?>view-assigned-station-to-sse.php">View Assigned Station To SSE Incharge</a>

          <a class="dropdown-item" href="<?php echo $redirectPage ?>aste-assign.php">Assign Station To ASTE</a>
          <a class="dropdown-item" href="<?php echo $redirectPage ?>view-assigned-station-to-aste.php">View Assigned Station To ASTE</a>
       </div>
     </li>
...
<a class="nav-link  active" href="<?php echo $redirectPage ?>logout.php"><i class="fa fa-sign-out" style="font-size:20px; color:#af0202;"></i>Logout</a>
</li>
