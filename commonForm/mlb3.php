...
सीसेई (सिग्नल)/प्रभारी: वार्षिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="mlb3FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="mlb3PdfBtn" onclick="generatePdf('MLB3','pdfBodyMLB3')"
...
`;
        ...
        document.getElementById("mlb3_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "MLB3" Form</div>`;
