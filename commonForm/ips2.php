...
<!-- Modal IPS2 -->
<div class="modal fade" id="componentForm_IPS2" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
           ...
           सीसेई (सिग्नल)/प्रभारी: त्रैमासिक
            ...
            <div class="card-footer d-flex justify-content-end ">
                ...
                <!-- <button type='button' id="ips2FormBtn" class="btn btn-success">Final Submit</button> -->
                <button type='button' id="ips2PdfBtn" onclick="generatePdf('IPS2','pdfBodyIPS2')"
...
<script>
    ...
    <td style="vertical-align:middle;width:22%" >`;
        ...
        </select> <button type="button" onclick="updateSingleValue('Done','IPS2','${element['ips_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
        ...
        </select> <button type="button" onclick="updateSingleValue('हो गया','IPS2','${element['ips_id']}','${tableDataForm['id']}')" class="btn btn-sm btn-success my-1">Update</button>`;
...
`;
        ...
        document.getElementById("ips2_body").innerHTML = displayHtml;
    ...
    function showSubComponent() {
        ...
        if (subCompo.length != 0) {
            ...
            let createSubcompo = `<div class="text-center h5 alert alert-danger my-2">Point "IPS2" Form</div>`;
