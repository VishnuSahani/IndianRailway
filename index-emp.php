				...
				<div class="col-xl-4 " >
					<div class="card" style="margin-top: 25px; min-height:380px; ">
						<div class="card-header">
						 <p class="text-center text-success h3">Employee Login</p> 	

						</div>
						<!-- card header -->
						<div class="card-body">
 <form id="my_form" action="login-employee-query.php" method="post">  
   
      <div class="input-group ">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="fa fa-user"></i></div>
        </div>
        <input type="text" class="form-control" id="username" name="username" placeholder="Enter Employee ID" required>
      </div>        <!-- input-group -->
